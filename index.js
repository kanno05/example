// -----------------------------------------------------------------------------
// 定数の設定
const LINE_CHANNEL_ACCESS_TOKEN = 'Key';
const APIAI_CLIENT_ACCESS_TOKEN = 'Key';
...
var dietitian = require('./response');
var app = express();
    ...
    for (var event of req.body.events){
        if (event.type == 'message' && event.message.text){
            ...
            var main = gotIntent.then(
                function(response){
                    console.log('api.aiからレスポンスが帰ってきた');
